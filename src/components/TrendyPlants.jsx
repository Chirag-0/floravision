    ...
    <section className="flex items-center justify-center">
           <div className="flex flex-col gap-6 justify-center items-center mt-20 p-3  w-full md:w-180 lg:w-240 ">
               ...
               <div className="p-4 flex items-center justify-center">
                <h4 className="text-2xl md:text-3xl font-semibold mb-2 inter">Our Trendy plants</h4>
               </div> 
              ...
              {/* Desk Decorations */}
                ...
                <div>
                    ...
                    <div className='flex gap-1.5 items-center '>
                        <button className="text-xs mt-2 px-3 py-1 rounded-lg border transition inter font-medium">
                      Explore
                    </button>
                    <img src="/bag.png" alt="bag" className='w-6 h-6 mt-1'/>
                    </div> 
